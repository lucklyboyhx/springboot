...
public class Branch implements Serializable{
	...
	private Integer branchNum;			//门店编号
		...
		public String toString() {
			return "Branch [branchNum=" + branchNum + ", branchCode=" + branchCode + ", branchName=" + branchName
					+ ", branchActived=" + branchActived + ", branchPostcode=" + branchPostcode + ", branchAddr="
					+ branchAddr + ", branchExpiration=" + branchExpiration + ", branchLng=" + branchLng
					+ ", branchLat=" + branchLat + ", branchProvince=" + branchProvince + ", branchCity=" + branchCity
					+ ", branchDistrict=" + branchDistrict + ", branchLinkMan=" + branchLinkMan + ", branchLinkPhone="
					+ branchLinkPhone + ", branchSettlementType=" + branchSettlementType + ", branchClosedTime="
					+ branchClosedTime + ", branchCreateTime=" + branchCreateTime + "]";
		}
